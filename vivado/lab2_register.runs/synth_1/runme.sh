...
HD_PWD='C:/Users/gaeun/Desktop/lab2_03_register/vivado/lab2_register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab2_register.tcl
